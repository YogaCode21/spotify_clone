            ...
            <table class="w-full text-sm text-left rtl:text-right text-white">
                ...
                <tbody>
                    <tr class="bg-[#f0f3f4] hover:bg-gray-50 text-black">
                        ...
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">Edson Co.</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">083281238</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">Tukad Balitar</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">Perusahaan obat panas</p>
                        </td>
                        <td class="px-6 py-2">
                            <div class="flex gap-1">
                                <a href="../edit/edit_data_supplier.php">
