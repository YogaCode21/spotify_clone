    ...
    <div class="w-full ml-16  mt-5 px-6 py-8 bg-white shadow-lg rounded-3xl ">
        <div class="flex justify-between">
            <div class="header">
                ...
                <p class="font-medium">Total 3201 Data Supplier</p>
            </div>
            <div class="side">
                <input class="bg-[#f0f3f4] pt-3 pb-3 pl-5 pr-32 rounded-full" type="text" placeholder="Cari nama obat">
                <a href="../input/add_data_transaksi.php" class="bg-[#b40001] text-white pt-3 pb-3 pl-8 pr-8 rounded-full text-lg">Add Data</a>
            </div>
        </div>
                ...
                <tbody>
                    <tr class="bg-[#f0f3f4] hover:bg-gray-50 text-black">
                        ...
                        <th scope="row" class="px-6 py-2 font-medium text-black whitespace-nowrap">
                            <p class="font-medium text-[#999999]">4</p>
                        </th>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">11</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">14</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">21</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">5000</p>
                        </td>
                        
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">105000</p>
                        </td>
                        <td class="px-6 py-2">
                            <div class="flex gap-1">
                                <a href="../edit/edit_data_transaksi.php">
