    ...
    <div class="w-full ml-16  mt-5 px-6 py-8 bg-white shadow-lg rounded-3xl ">
        <div class="flex justify-between">
            <div class="header">
                ...
                <p class="font-medium ">Total 4547 Obat</p>
            </div>
            <div class="side">
                <input class="bg-[#f0f3f4] pt-3 pb-3 pl-5 pr-32 rounded-full" type="text" placeholder="Cari nama obat">
                <a href="../input/add_data_obat.php" class="bg-[#b40001] text-white pt-3 pb-3 pl-8 pr-8 rounded-full text-lg">Add Data</a>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-white">
                <thead class="text-xs text-[#F14040] uppercase bg-[#f0f3f4]">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <p class="font-medium ">Kategori Obat</p>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <p class="font-medium ">Harga Jual</p>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <p class="font-medium ">Harga Beli</p>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <p class="font-medium ">Stok Obat</p>
                        </th>
                        <th scope="col" class="px-6 py-3">
                ...
                <tbody>
                    <tr class="bg-[#f0f3f4] hover:bg-gray-50 text-black">
                        ...
                        <th scope="row" class="px-6 py-2text-black whitespace-nowrap">
                            <p class="font-medium text-[#999999]">41</p>
                        </th>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">PT. Sejahtera</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">Paracetamol</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">Obat panas</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">30000</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">30000</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">100</p>
                        </td>
                        <td class="px-6 py-2">
                            <p class="font-medium text-[#999999]">3x Sehari</p>
                        </td>
                        <td class="px-6 py-2">
                            <div class="flex gap-1">
                                <a href="../edit/edit_data_obat.php">
