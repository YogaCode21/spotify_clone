...
<div class="login-view flex items-center justify-center ">
    <div class=" flex items-center flex-row gap-[100px] h-screen max-[990px]:flex-col">
        <div class="login_input-container text-center min-w-[400px]">
            ...
            <form action="../view/control.php?page=dashboard" class="input-container flex flex-col items-end gap-4 mt-9 mb-9 text-end" method="post">
                <input type="text" name="username" placeholder="Enter Username" class="pr-7 pl-7 pt-4 pb-4 w-full bg-[#F4F0F0] text-black rounded-2xl" autocomplete="off">
                <input type="password" name="password" placeholder="Password" class="pr-7 pl-7 pt-4 pb-4 w-full bg-[#F4F0F0] text-black rounded-2xl" autocomplete="off">
                <a href="./forgot.php" class="w-fit">Forgot Password?</a>
