<div class="flex flex-col">
    <div class="w-full ml-16  mt-5 px-6 py-8 bg-white shadow-lg rounded-3xl ">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-white">
                <thead class="text-xs text-[#F14040] uppercase bg-[#f2f2f2]">
                    <tr>
                ...
                <tbody>
                    <tr class="bg-[#f2f2f2] hover:bg-gray-50 text-black">
                        <td class="w-4 p-4">
    ...
    <div class="w-full ml-16  mt-5 px-4 py-4 bg-white shadow-lg rounded-3xl ">
